...
|-|-|
|Un fichero de logs con millones de entradas|Se buscan todos los eventos de un minuto concreto
...
|Un log de accesos web: 10 millones de IPs registradas|Se comprueba si una IP concreta accedió hoy
